...
public class JumpUtils {
    // 通用请求码
    public static final int REQ_FOR_FORWARD = 0x121;
    ...
    public static void invokeActivity(Context context, Class<?> to, String paraName, Object paraValues, int requestCode) {
        Intent intent = new Intent();
        intent.setClass(context, to);
        if (paraValues != null)
            initParas(intent, paraName, paraValues);
